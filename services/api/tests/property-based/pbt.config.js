...
exports.GENERATORS = exports.PROPERTY_TAGS = exports.PBT_CONFIGURATION = void 0;
exports.PBT_CONFIGURATION = {
...
exports.GENERATORS = {
    ...
    validGST: (pan) => {
        ...
        const panToUse = pan || exports.GENERATORS.validPAN();
        const entityCode = Math.floor(Math.random() * 10);
        const checkDigit = Math.floor(Math.random() * 10);
        return `${stateCode}${panToUse}${entityCode}Z${checkDigit}`;
    }
};
exports.default = exports.PBT_CONFIGURATION;
//# sourceMappingURL=pbt.config.js.map