                ...
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                    <RevenueIcon 
                      ...
                      sx={{ mr: 1 }} 
                    />
                    <Typography variant="h6">{formatCurrency(performance.totalRevenue)}</Typography>
                  </Box>
                  <Typography variant="body2" color="text.secondary">
                    Total Revenue
                  </Typography>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell align="right">{formatCurrency(performance.averageOrderValue)}</TableCell>
                      <TableCell>Average value per order with this offer</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Revenue per Day</TableCell>
                      <TableCell align="right">{formatCurrency(performance.revenuePerDay)}</TableCell>
