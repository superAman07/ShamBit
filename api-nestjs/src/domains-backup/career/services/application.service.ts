...
export class ApplicationService {
    ...
    async createApplication(jobId: string, applicationDto: CreateApplicationDto, userId?: string) {
    ...
    async updateStatus(id: string, status: string, reviewedBy: string, notes?: string) {
        ...
        return this.applicationRepository.updateStatus(id, status, reviewedBy, notes);
    }
}
