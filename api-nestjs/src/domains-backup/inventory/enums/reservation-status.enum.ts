...
export const ReservationStatusTransitions: Record<ReservationStatus, ReservationStatus[]> = {
  [ReservationStatus.ACTIVE]: [ReservationStatus.COMMITTED, ReservationStatus.RELEASED, ReservationStatus.EXPIRED],
...
export function canTransitionTo(from: ReservationStatus, to: ReservationStatus): boolean {
