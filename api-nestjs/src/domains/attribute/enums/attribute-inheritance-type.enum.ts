...
export const AttributeInheritanceTypeLabels: Record<
  AttributeInheritanceType,
  string
> = {
...
export const AttributeInheritanceTypeDescriptions: Record<
  AttributeInheritanceType,
  string
> = {
  [AttributeInheritanceType.INHERITED]:
    'Attribute inherited from parent category without modifications',
  [AttributeInheritanceType.OVERRIDDEN]:
    'Attribute inherited from parent but with category-specific overrides',
  [AttributeInheritanceType.DIRECT]:
    'Attribute directly assigned to this category',
};

export const AttributeInheritanceTypeIcons: Record<
  AttributeInheritanceType,
  string
> = {
...
export const AttributeInheritanceTypeColors: Record<
  AttributeInheritanceType,
  string
> = {
...
export const requiresSourceCategory = (
  type: AttributeInheritanceType,
): boolean => {
