...
export const ProductModerationStatusLabels: Record<
...
export const ProductModerationStatusIcons: Record<
  ProductModerationStatus,
  string
> = {
...
export const ALLOWED_MODERATION_TRANSITIONS: Record<
  ProductModerationStatus,
  ProductModerationStatus[]
> = {
  [ProductModerationStatus.PENDING]: [
...
export const requiresModeratorAction = (
...
export const isModeratorActionComplete = (
  status: ProductModerationStatus,
): boolean => {
  return [
    ProductModerationStatus.APPROVED,
...
export const getModerationPriority = (
  status: ProductModerationStatus,
): number => {
