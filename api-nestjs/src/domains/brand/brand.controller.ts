...
export class BrandController {
  ...
  @ApiQuery({
    ...
    required: false,
    type: Boolean,
    description: 'Filter by global brands',
  })
  @ApiQuery({
    name: 'search',
    required: false,
  ...
  async updateStatus(
    ...
    return this.brandService.updateStatus(
      id,
      statusUpdate,
      updatedBy,
      userRole,
  ...
  async createBrandRequest(
    ...
    return this.brandRequestService.createRequest(
      requestDto,
      sellerId,
    ) as Promise<BrandRequestResponseDto>;
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Brand requests retrieved successfully',
    type: BrandRequestListResponseDto,
  })
  @ApiQuery({
    name: 'status',
    required: false,
  ...
  async getPendingRequests(): Promise<BrandRequestResponseDto[]> {
    return this.brandRequestService.getPendingRequests() as Promise<
      BrandRequestResponseDto[]
    >;
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Brand request retrieved successfully',
    type: BrandRequestResponseDto,
  })
  ...
  async getBrandRequestById(
    ...
    return this.brandRequestService.findById(
      id,
    ) as Promise<BrandRequestResponseDto>;
  }
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Handle brand request - approve or reject (Admin only)',
  })
  @ApiResponse({
    status: 200,
    description: 'Brand request handled successfully',
    type: BrandRequestResponseDto,
  })
  @ApiResponse({
    status: 400,
    description: 'Invalid request status or missing rejection reason',
  })
  async handleBrandRequest(
    ...
    return this.brandRequestService.handleRequest(
      id,
      handleDto,
      adminId,
    ) as Promise<BrandRequestResponseDto>;
  ...
  @ApiResponse({
    status: 200,
    description: 'Brand request cancelled successfully',
    type: BrandRequestResponseDto,
  })
  ...
  async cancelBrandRequest(
    ...
    return this.brandRequestService.cancelRequest(
      id,
      sellerId,
    ) as Promise<BrandRequestResponseDto>;
  }
  ...
  async getAuditStatistics(
    ...
    return this.brandAuditService.getAuditStatistics(
      dateFromParsed,
      dateToParsed,
    );
  }
