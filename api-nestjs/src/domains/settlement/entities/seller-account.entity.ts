...
export class SellerAccount {
  ...
  canSubmitKyc(): boolean {
    return this.kycStatus === KycStatus.PENDING || this.kycStatus === KycStatus.REJECTED;
  }
  ...
  hasRazorpayIntegration(): boolean {
    return !!(this.razorpayAccountId && this.razorpayContactId && this.razorpayFundAccountId);
  }
  ...
  getCompletionPercentage(): number {
    ...
    if (this.businessType !== 'INDIVIDUAL' && this.kycDocuments?.gstCertificate?.verified) completed++;
