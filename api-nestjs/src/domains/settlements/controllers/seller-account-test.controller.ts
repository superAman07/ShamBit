...
export class SellerAccountTestController {
  ...
  @ApiOperation({
    ...
    description:
      'Test version that accepts token "test_admin_token_12345" for testing security. Use Bearer test_admin_token_12345',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'This endpoint should work without authentication for comparison',
  })
