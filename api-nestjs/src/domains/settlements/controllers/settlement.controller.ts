...
export class SettlementController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a paginated list of settlements with optional filtering and includes',
  })
  @ApiResponse({
    status: 200,
  ...
  async findBySettlementId(
    ...
    return this.settlementService.findBySettlementId(
      settlementId,
      includes,
      user.id,
      user.role,
  ...
  @ApiResponse({
    status: 200,
    description: 'Settlement reconciled successfully',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Calculate settlement amounts for a seller within a specific period',
  })
  @ApiBody({
  ...
  @ApiResponse({
    status: 403,
    description:
      'Access denied - sellers can only calculate their own settlements',
  })
  ...
  async checkEligibility(
    ...
    return this.settlementValidationService.checkSettlementEligibility(
      sellerId,
      amount,
    );
  }
