...
/**
 * Poppins font family with all required weights
 * Configured for Regular, Medium, SemiBold, and Bold
 */
...
/**
 * ShamBit Typography system using Poppins font family
 * Follows Material 3 typography scale with custom font
 * Tested across different screen densities (mdpi, hdpi, xhdpi, xxhdpi, xxxhdpi)
 */
val Typography = Typography(
    ...
    // Title styles - Used for card titles and prominent text
    ...
    // Label styles - Used for buttons, tabs, and labels
